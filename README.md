...
### [Práctica 2. Configurar un plan con miembros y permisos](Capítulo_2)
...
### [Práctica 3. Crear tareas reales para un proyecto TI](Capítulo_3)
...
### [Práctica 4. Crear plantilla y organizar un plan por buckets](Capítulo_4)
...
### [Práctica 5. Vincular un plan con Teams y verificar notificaciones](Capítulo_5)
...
### [Práctica 6. Generar reporte y revisar métricas de un plan](Capítulo_6)

  - **Descripción**: En esta práctica los participantes aprenderán a interpretar el estado de un plan a partir de sus vistas de progreso y distribución, permitiendo comprender la situación actual del trabajo de manera operativa; además, exportarán la información del plan para realizar un análisis rápido en Excel y, con base en estos datos, elaborarán un reporte breve y útil que facilite el seguimiento del trabajo de forma clara y estructurada.

  - ⏱️**Duración estimada**: 15 min.



### [Práctica 7. Elaborar checklist y plan de puesta en marcha](Capítulo_7)

  - **Descripción**: En esta práctica los participantes aprenderán a diseñar un checklist mínimo para implementar Planner en un equipo TI, estableciendo una base clara para su uso; además, definirán reglas de gobernanza, mantenimiento y escalamiento del plan que permitan asegurar su correcta operación y sostenibilidad en el tiempo..
